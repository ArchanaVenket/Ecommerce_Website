...
<html> 
	<head> 
		<title>StyleCart Shopping Web Application</title> 
		<link rel="stylesheet"
				href="shop.css"> 
	</head> 
	<body> 
		<header> 
			...
			$user = $_SESSION["user"]; 
			echo $user["name"]; 
			?> to StyleCart Shopping Web Application</h1> 
		</header> 
		<nav> 
		<ul>
    <li><a href="shop.html" style="font-size: 16px;">Home</a></li>
    <li><a href="shop.html" style="font-size: 16px;">Shop</a></li>
    <li><a href="cart.php" style="font-size: 16px;">Cart</a></li>
